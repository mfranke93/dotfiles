...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        local wallpaper = "/home/max/Pictures/wallpaper"
...
globalkeys = gears.table.join(
    ...
    awful.key({ }, "XF86ScreenSaver", function() awful.spawn("/home/max/bin/i3exit lock") end,
              {description = "lock screen", group = "system"}),
    awful.key({ modkey }, "Print", function() awful.spawn("/home/max/bin/i3exit") end,
              {description = "show exit menu", group = "system"}),

    awful.key({ }, "XF86AudioPlay", function() awful.spawn("/home/max/bin/mpcctl toggle") end,
              {description = "pause/play mpd", group = "multimedia"}),
    awful.key({ }, "XF86AudioPrev", function() awful.spawn("/home/max/bin/mpcctl prev") end,
...
-- {{{ Autostart
awful.spawn("compton")  -- composite manager
awful.spawn("unclutter -idle 5.0 -root")  -- hide mouse on inactivity
-- }}}
